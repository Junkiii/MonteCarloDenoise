...
class OIDN_AE(nn.Module):
    def __init__(self, in_channels=9, out_channels=3):
        super(OIDN_AE, self).__init__()
        ...
        self.dec_conv4a = Conv(ec5,     dc4)
        self.dec_conv4b = Conv(dc4,     dc4)
        self.dec_conv3a = Conv(dc4,     dc3)
        self.dec_conv3b = Conv(dc3,     dc3)
        self.dec_conv2a = Conv(dc3,     dc2)
        self.dec_conv2b = Conv(dc2,     dc2)
        self.dec_conv1a = Conv(dc2,     dc1a)
